...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen>
  ...
  void initState() {
    ...
    // Give Clerk some time to mount before showing onboarding
  ...
  Future<void> _signIn() async {
    ...
    await prefs.setBool('onboarding_done', true);
    if (mounted) {
      // Push Clerk sign-in and then go home after it completes
      await Navigator.of(context).pushNamed('/clerk-login');
      if (mounted) Navigator.of(context).pushReplacementNamed('/home');
    }
  }
            ...
            body: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('LOGGING IN...', style: AppTheme.krona(size: 16, letterSpacing: 2)),
                ],
              ),
            ),
          );
